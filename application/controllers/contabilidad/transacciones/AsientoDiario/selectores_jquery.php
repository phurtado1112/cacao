...
class Selectores_jquery extends CI_Controller 
{
	...
	public function index()
	{
		...
		$this->load->view('AsientoDiario/selectores_jquery_view',$data);		
	}
	...
	public function array_selectores()
	{
		...
		if($this->form_validation->run() == FALSE)
		{
			...
			{
				redirect(base_url().'AsientoDiario/selectores_jquery');
			}
		}		
	}
 
    public function mostrar_etiquetas()
	{
		$data['etiquetas'] = $this->selectores_jquery_model->etiquetas();
		$this->load->view('AsientoDiario/etiquetas_view',$data);
	}
}