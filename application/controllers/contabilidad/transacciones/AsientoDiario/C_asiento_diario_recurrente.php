...
class C_asiento_diario_recurrente extends CI_Controller {
    ...
    public function index() {
        $this->load->view('contabilidad/transacciones/AsientoDiario/V_listar_asiento_diario_recurrente');
    }

    public function crear() {
        $this->load->model('contabilidad/transacciones/AsientoDiario/M_Asiento_Diario_Recurrente');
        ...
        $this->load->view('contabilidad/transacciones/AsientoDiario/V_crear_asiento_diario_recurrente', $origen);
    }
