...
<?= form_dropdown($idorigen_asiento_diario, $lista_origen_asiento_diario); ?> </td>
                        ...
                        <th rowspan="2">Descripción de Asiento
                            <textarea  placeholder="Descripcion del asiento de diario" id="descripcion_asiento_diario" class="textarea" maxlength="200"><?php
if ($asiento_diario_recurrente != "") {
...
<?php echo form_dropdown('idmoneda', $idmoneda); ?></div></td>
                ...
                <div class="row divboton col-sm-pull-4"> 
                    <div class="row col-md-offset-7">
                        <input id="total_debito" name ='total_debito' value="<?php
                            if ($asiento_diario_recurrente != "") {
                                echo $asiento_diario_recurrente[0]['balance_debito'];
                            } else {
                                echo "0.0";
                            }
                            ?>" type="text" readonly class='col-lg-4 valorDC'>
                        <input id="total_credito" name ='total_credito' value="<?php
                               if ($asiento_diario_recurrente != "") {
                                   echo $asiento_diario_recurrente[0]['balance_credito'];
                               } else {
                                   echo "0.0";
                               }
                            ?>" readonly class='col-lg-4  col-xs-push-1 valorDC'>
                    </div>
