<div class="container">
    <div class="row">
        ...
        <div class="span3 well">
                    ...
                    <?php 
                        $i=1;
                            foreach ($ad_detalle as $ad_detalle){
                                ...
                                echo"<tr id='".$i."' class='asiento_diario_detalle ".$clase_extra."'>
                            <td><div class='numero_asiento'>".$i."</div><input type='hidden' class='numero_transaccion' value='".$i."'></td>
            ...
            <button class="btn btn-primary btn-lg " id="guardar">Editar</button>
