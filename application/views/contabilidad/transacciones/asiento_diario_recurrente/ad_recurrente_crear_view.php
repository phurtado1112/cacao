           ...
           <input type="hidden" id="recoge_fecha" value="<?php echo date('Y-m-d') ;?>">
            ...
            <div class="form-group col-lg-12"> 
                ...
                <div class="form-group col-lg-5 col-lg-push-2">
                    <input id="total_debito" name ='total_debito' value="0.0" type="text" readonly class='col-lg-4 col-lg-pull-1'>
                    <input id="total_credito" name ='total_credito' value="0.0" readonly class='col-lg-4'>
                </div>
           </div> 
        </div>
    </div>
