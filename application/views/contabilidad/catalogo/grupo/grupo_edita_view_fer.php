                ...
                <div class="span3 well">
                    ...
                    <div class="block-content collapse in valor" style="width: 80%; margin: auto; padding:0px 10px;">
                        ...
                        <table class="table table-striped ">
                            ...
                            <tr>
                            <th>Aceptar cuentas</th>
                                <th>
                                   <label>No</label>      
                                   <input type = "radio" name = "acepta_cuenta"  value = "0" <?php if($lista_por_id[0]['acepta_cuenta']== 0){echo "checked = 'checked'";}?>/>
                                   &nbsp;&nbsp;
                                   <label>Si</label>      
                                   <input type = "radio" name = "acepta_cuenta"  value = "1"  <?php if($lista_por_id[0]['acepta_cuenta']== 1){echo "checked = 'checked'";}?>/>
                                </th>
                            </tr>
                        </table>
