...
class Asiento_diario_detalle_model extends CI_Model {
    ...
    public function asiento_diario_detalle_por_id_ad($idasiento_diario = NULL) {
        if ($idasiento_diario != NULL) {
            ...
            $query = $this->db->query('SELECT * FROM asiento_diario_detalle WHERE idasiento_diario ='.$idasiento_diario.' ORDER BY numero_transacciones');
        }
    ...
    public function asiento_diario_detalle_eliminar($numero_transacciones = NULL,$idasiento_diario = NULL) {
        if ($numero_transacciones != NULL) {
            ...
            $this->db->query("DELETE FROM asiento_diario_detalle WHERE idasiento_diario = ".$idasiento_diario." AND numero_transacciones = ".$numero_transacciones."");
        }
    }
    
    public function asiento_diario_detalle_modificar($idasiento_diario,$numero_transacciones
