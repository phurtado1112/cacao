...
function quitar_transacciones() {
    ...
    $("tr.agregado").each(function () {
        ...
        $(this).find('td:nth-child(3)>input').attr('id', "descripcion_cuenta_contable_" + i);
...
$(document).ready(function () {
    ...
    $("#agregar").on('click', generar_transacciones);

    $("#campos_agregados").on('click', ".quitar", quitar_transacciones);
